...
2. Commit and push **source** to `main`, including `website/` (Flutter web for Cloudflare Pages at https://khmercarlendar.pages.dev). Do not commit generated `apk-spa/`, `dist/`, `flutter-web/`, or `public/native/` binaries. Those last three are created during publish.
